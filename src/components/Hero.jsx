export default function Hero() {
  return (
    <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden bg-transparent">
      <div className="absolute top-20 left-[12%] w-72 h-72 rounded-full bg-gradient-to-br from-primary-container/25 to-white/5 blur-[100px] pointer-events-none animate-shimmer-soft" />
      <div className="absolute bottom-10 right-[8%] w-80 h-80 rounded-full bg-gradient-to-tl from-primary/40 to-primary-container/20 blur-[120px] pointer-events-none animate-shimmer-soft [animation-delay:1.2s]" />
