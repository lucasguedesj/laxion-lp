...
export default function Footer() {
  return (
    <footer className="bg-surface-container pt-20 pb-10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="pt-10">
          <p className="text-on-surface-variant text-sm text-center">© {new Date().getFullYear()} Hazze Inteligência Digital. Todos os direitos reservados.</p>
        </div>
      </div>
    </footer>
  );
